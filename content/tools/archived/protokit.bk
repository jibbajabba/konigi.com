+++
title = "Protokit [Archived]"
description = ""
tags = ["tools", "prototyping", "ui design"]
date = "2009-11-30"
categories = ["tools"]
slug = "protokit"
summary=""
featuredimg = "//media.konigi.com/tools/protokit/protokit.png"
...
<p>Protokit was an experimental project to develop a toolkit for creating HTML prototypes. It uses the following open source libraries and plugins: <a href="//blueprintcss.org/">Blueprint</a>, <a href="//jquery.com/">jQuery</a>, <a href="//jqueryui.com/">jQuery UI</a>, <a href="//ivorycity.com/blog/jquery-template-plugin/">jQuery Templates</a>, and <a href="//ixedit.com/">iXEdit</a>. More information about the included libraries and their licensing agreements can be found in theREADME file.</p>
